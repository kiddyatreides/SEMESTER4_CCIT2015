<%-- 
    Document   : Delete_Categories
    Created on : Apr 16, 2015, 5:27:07 PM
    Author     : Badrus
--%>
...
<body>
    <form method="post" action="Admin_Categories_del" >
	<div class="container">
        ...
        <div class="row">
            ...
            <tr>
                ...
                <td><a href="Admin-Categories.jsp"><input type="submit" value="no"/></a></td>
            </tr>
                        <%--<tr>
